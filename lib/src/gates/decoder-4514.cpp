...
// Last update Sat Feb 11 15:14:28 2017 Riamon Vincent
//

#include "decoder-4514.hpp"

nts::decoder4514::decoder4514(__attribute__((unused))nts::Tristate val) {
}
...
void nts::decoder4514::SetLink(size_t this_pin, nts::IComponent& comp, size_t target_pin) {
