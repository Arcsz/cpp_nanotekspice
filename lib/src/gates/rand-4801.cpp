...
nts::rand4801::rand4801(__attribute__((unused))nts::Tristate val) {
}
...
void nts::rand4801::SetLink(size_t this_pin, nts::IComponent& comp, size_t target_pin) {
  if (this_pin > 14) {
    throw nts::PinException(nts::pinError("C4801", this_pin));
